...
const Experience = () => {
      ...
      <div className="ml-20 mb-12">
        <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
            <div>
              <h3 className="text-xl font-accent font-semibold text-gray-900 dark:text-white mb-1">
                {exp.position}
              </h3>
              {exp.website ? (
                <a 
                  ...
                  className="text-blue-600 dark:text-blue-400 font-primary font-medium text-lg hover:text-blue-800 dark:hover:text-blue-300 transition-colors duration-200"
                >
                  {exp.company} 🔗
                </a>
              ) : (
                <p className="text-blue-600 dark:text-blue-400 font-primary font-medium text-lg">
                  {exp.company}
                </p>
              )}
            </div>
            <div className="mt-2 md:mt-0">
              <span className="inline-block bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 px-3 py-1 rounded-full text-sm font-secondary font-medium">
                {exp.duration}
              </span>
            </div>
          </div>
  ...
  return (
    <section id="experience" className="py-20 bg-white dark:bg-gray-100 relative">
